...
<footer class="navbar">
  ...
  <a href="About.php" class="w3-button w3-bar-item">Raphael Son Hing - 1500458</a>
    ...
    <body>
        ...
        <div class="dead">
            <form action = "incorrct_login.php" method = "post">
            <h1>Incorrect credientials</h1>
            <table style="margin-left:auto;margin-right:auto;">
                 ...
                 <tr>
                    ...
                    <div class = "control_font">
                        The password or name is incorrect, please go back and try again.
                    </div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input type = "button" name = "btnchangr" class = "button_style" onclick="location='login.php'"
                        value = "Login"><br> 
                    </td>
                  </tr>
